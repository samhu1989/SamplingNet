...
\title{NetNet: A Network of ``Network Prediction" for 3D Shape Generation from a Single Image \thanks{These match the formatting instructions of IJCAI-07. The support of IJCAI, Inc. is acknowledged.}}
